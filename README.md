...
In `./hosts/<host>/tags.nix` you can set a list of tags.
The auto importer in the `all.nix` files then only import files automatically that have no tags or only matching tags.
